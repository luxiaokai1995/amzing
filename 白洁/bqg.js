...
function login(){
document.writeln("<div class=\"ywtop\"><div class=\"ywtop_con\"><div class=\"ywtop_sethome\"><a href=\"/zhuomian.php\">将三好小说网快捷键下载到桌面</a></div>");
document.writeln("		<div class=\"ywtop_addfavorite\"><a href=\"javascript:window.external.addFavorite(\'http://www.shaoshuge.com\',\'三好小说网_书友最值得收藏的网络小说阅读网\')\">收藏三好小说网</a></div>");
...
document.writeln("<p>Copyright &copy; 2016 三好小说网 All Rights Reserved.</p>");
document.writeln("<p> <script src=\'https://s19.cnzz.com/z_stat.php?id=1274992728&web_id=1274992728\' language=\'JavaScript\'></script></p>");

}
function read_panel(){
document.writeln("<div class=\"header_search\"><form name=\"form\" action=\"/modules/article/search.php\" id=\"sform\" target=\"_blank\"><input type=\"text\" value=\"请输入关键字。\" name=\"searchkey\" class=\"search\" id=\"wd\"  baiduSug=\"2\" /><button id=\"sss\" type=\"submit\"> 搜 索 </button></form></div>"); 
document.writeln("<div class=\"userpanel\">&nbsp;<font color=\"red\">报错：</font><a target=\"_blank\" href=\"http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=xxxled@126.com\">通过邮件</a>、<a href=\"/newmessage.php?tosys=1&title="+booktitle+"-章节错误&content=错误章节为:"+readtitle+"\" >站内短信</a><br /><a target=\"_blank\" href=\"/ziti.html\"><b>原图片版</b></a>&nbsp;&nbsp;<a target=\"_blank\" href=\"/jifen.html\">积分规则</a>&nbsp;&nbsp;<a target=\"_blank\" href=\"/dns.html\">给亲爱的读者的信</a></div>");
}
function ttt(){
